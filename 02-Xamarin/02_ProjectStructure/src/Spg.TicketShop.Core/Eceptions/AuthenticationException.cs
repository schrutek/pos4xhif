...
namespace Spg.TicketShop.Core.Eceptions
{
    public class AuthenticationException : Exception
    {
        ...
        public AuthenticationException(string message, [CallerMemberName] string methodName = "") : base(message)
        {
            MethodName = methodName;
        }
        public AuthenticationException(string message, Exception innerException, [CallerMemberName] string methodName = "") : base(message, innerException)
        {
            MethodName = methodName;
        }
