...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Spg.TicketShop.App.Android.dll" comes first in this list. */
		"Spg.TicketShop.App.Android.dll",
		"FormsViewGroup.dll",
		"Microsoft.Bcl.AsyncInterfaces.dll",
		"Spg.TicketShop.App.dll",
